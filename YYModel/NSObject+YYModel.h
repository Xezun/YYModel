...
/**
 ...
 @li `NSString` or `NSNumber` -> c number, such as BOOL, int, long, float, NSUInteger...
 @li `NSString` -> NSDate, parsed with format "yyyy-MM-dd'T'HH:mm:ssZ", "yyyy-MM-dd HH:mm:ss" or "yyyy-MM-dd".
 @li `NSString` -> NSURL.
 @li `NSValue` -> struct or union, such as CGRect, CGSize, ...
 @li `NSString` -> SEL, Class.
 */
...
/**
 ...
 @li `NSString`, `NSNumber` -> c number, such as BOOL, int, long, float, NSUInteger...
 @li `NSString` -> NSDate, parsed with format "yyyy-MM-dd'T'HH:mm:ssZ", "yyyy-MM-dd HH:mm:ss" or "yyyy-MM-dd".
 @li `NSString` -> NSURL.
 @li `NSValue` -> struct or union, such as CGRect, CGSize, ...
 @li `NSString` -> SEL, Class.
...
/**
 ...
 @param json  A json array of `NSArray`, `NSString` or `NSData`. Example: [{"name","Mary"},{name:"Joe"}]
...
/**
 ...
 @param json  A json dictionary of `NSDictionary`, `NSString` or `NSData`. Example: {"user1":{"name","Mary"}, "user2": {name:"Joe"}}
